...
<div style="background-image: url('../img/boat.png');  background-size: cover;">    
    ...
    <div class="header">
        <div class="logo h1">
            <h1 class="logo-text fw-bold">【Ｍｙ予想編集モード】</h1>
        </div>
    ...
    <div class="main container">
        ...
        <form method="POST" action="{{ route('browse_update.update') }}">
                @csrf
                    ...
                    <div class="right col-8">
                        <div class=" h2 border-bottom fw-bold entry-title">進入予想</div>
                            <div class="entry fw-bold">
                                ...
                                <input id="entry-boat" type="text" name="course1" value="{{ $courses->course1 }}" placeholder="" />号艇                
                                <div class="entry-cource fw-bold ">2コース</div> 
                                <input id="entry-boat" type="text" name="course2" value="{{ $courses->course2 }}" placeholder="" />号艇
                                <div class="entry-cource fw-bold ">3コース</div> 
                                <input id="entry-boat" type="text" name="course3" value="{{ $courses->course3 }}" placeholder="" />号艇
                                <div class="entry-cource fw-bold ">4コース</div> 
                                <input id="entry-boat" type="text" name="course4" value="{{ $courses->course4 }}" placeholder="" />号艇
                                <div class="entry-cource fw-bold ">5コース</div> 
                                <input id="entry-boat" type="text" name="course5" value="{{ $courses->course5 }}" placeholder="" />号艇
                                <div class="entry-cource fw-bold ">6コース</div> 
                                <input id="entry-boat" type="text" name="course6" value="{{ $courses->course6 }}" placeholder="" />号艇
                            </div>
                        <div class="comment">
