...
<body>
    ...
    {{-- メイン部分左側 着順 会場 R 入力コンテンツ --}}
        ...
        <div class="right col-8">
            ...
            <div class="comment">
                <div class="comment-logo h2 border-bottom fw-bold">コメント</div>
                <textarea name="introduction" id="introduction" cols="67" rows="17"placeholder="予想コメントを書いてください" class="form-control"></textarea>
