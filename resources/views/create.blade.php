...
<div style="background-image: url('img/boat.png');  background-size: cover;">    
    ...
    <div class="header">
        ...
        <div class="header-btn">
            <button type=“button” class="btn btn-success  fw-bold " onclick="location.href='http://localhost:8000/index'">予想一覧へ</button>
        </div>
    </div>
    {{-- ここからメイン部分 --}}
        ...
        <div class="row">
            ...
            <div class="right col-8">
                ...
                <div class="comment">
                    ...
                    <p class="help-block">※1100文字以内で書いてください<button type=“button” class="btn btn-success  fw-bold create-btn " onclick="location.href='http://localhost:8000/browse'">予想を作成する</button></p>
                </div>    
            </div>
        </div>
    </div>
